% a slightly modified form of audioextraction file from pyAudioAnalysis
...
import glob
import numpy
#import mlpy  # I can't install mlpy
import pickle
import aifc
import math
...
# This file was copied from pyAudioAnalysis
...
# def phormants(x, Fs): # this uses LPC which doesn't work
#     N = len(x)
#     w = numpy.hamming(N)
#
